...
class RRDB(nn.Module):
    ...
    def __init__(self, num_feat, num_grow_ch=32):
        ...
        self.eca0 = ESAblock(numfeat,16)
        self.eca1 = ESAblock(numfeat,16)
        self.eca2 = ESAblock(numfeat,16)
        self.eca3 = ESAblock(numfeat,16)
        self.cat =nn.Conv2d(4*numfeat,numfeat,kernel_size=3,padding=1)
    ...
    def forward(self, x):
        ...
        out = self.cat(torch.cat((out00,out11,out22,out33),1))
        # Emperically, we use 0.2 to scale the residual for better performance
        return out * 0.2 + x
